...
'''.strip()
    ...
    for start, end, replacement in self.dmp.patch_apply_perfect_replacements(patches, text1):
    ...
    # texts = list(self.dmp.patch_perfect_apply_gen(patches, text1))
    # import pdb; pdb.set_trace()

    # 1. apply regular patch
    # 2. generate new patch
    # 3. patch_apply_gen_perfect 
